This Ruby on Rails MVC application is an analog of Instagram, which allows users to share photos and videos, follow other users, like and comment on their posts, and send direct messages.
